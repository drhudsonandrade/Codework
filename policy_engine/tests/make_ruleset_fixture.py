...
def main() -> None:
    ...
    lines = ["REGRAS PROJETO GENOMA","STATUS NORMATIVO: VIGENTE","VERSÃO NORMATIVA: v3.4","DATA FORMAL DE EMISSÃO E VIGÊNCIA: 17/08/2026","IDENTIFICADOR NORMATIVO: GENOMA-RULESET-v3.4",f"ARQUIVO CANÔNICO: {CANONICAL}","FIXTURE DE TESTE: NÃO É O ARTEFATO NORMATIVO; USO EXCLUSIVO EM CI DE INFRAESTRUTURA.",""]
    ...
    (manifests / "RULESET_V3.4.sha256").write_text(f"{digest}  {CANONICAL}\n", encoding="ascii")
    print(ruleset); print(manifests / "RULESET_V3.4.sha256")
