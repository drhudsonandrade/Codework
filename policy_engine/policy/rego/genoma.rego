...
# object.get with an empty default makes an omitted canonical filename deny, not
# skip: an undefined input.ruleset.canonical_filename would leave the rule body
# undefined and silently admit the manifest.
