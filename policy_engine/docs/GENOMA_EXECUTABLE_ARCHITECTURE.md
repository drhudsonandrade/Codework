...
CLI, HTTP and OCI are first-class. MCP clients, web UIs, tunnels, orchestrators, projections or future providers are adapters only. Their disappearance must not prevent local policy execution.
