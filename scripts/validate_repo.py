...
REQUIRED_PATHS = (
    ...
    "scripts/ngs_formats.py", "scripts/vcf_projection.py", "reporting/assay.py",
    ...
    "reporting/section_attestations.py", "scripts/section_attestation_report.py",
    "config/section_attestations_array.json",
