...
class PolicyEngineUtf8PortabilityTest(unittest.TestCase):
    def test_policy_engine_test_text_io_is_explicit_utf8(self):
        violations: list[str] = []
        for path in sorted(POLICY_TESTS.rglob("*.py")):
        ...
        self.assertEqual([], violations, f"text I/O calls without explicit UTF-8: {violations}")
