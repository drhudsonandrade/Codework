...
The active language gate currently discovers 46 Markdown documents across repository-root developer docs, `docs/**`, adapter/MCP READMEs, policy-engine documentation, and active design specifications. Discovery is dynamic, so new active Markdown enters the gate automatically. It explicitly excludes `docs/evidence/**`, `docs/audits/**`, `docs/history/**`, `docs/superpowers/plans/**`, `docs/superpowers/checkpoints/**`, `docs/superpowers/evidence/**`, `normative/**`, `template_store/**`, and `vendor/**`. Generated/vendor directories such as `node_modules`, `dist`, and `build` are also excluded. These are evidence, audit, history, execution-plan, continuity, canonical normative, template/vendor, or generated surfaces rather than active developer documentation. End-user/localized output remains a preservation boundary rather than a translation target.
