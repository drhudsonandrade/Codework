...
- The CI contract permits the raw scanner token only in its private import and permits the private implementation name only in that import plus the wrapper call.
