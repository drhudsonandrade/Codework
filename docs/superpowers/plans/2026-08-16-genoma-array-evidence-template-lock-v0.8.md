...
O plano original foi preservado em `docs/history/` porque descreve uma baseline normativa substituída. Ele permanece disponível para proveniência, mas não é uma fonte operacional ativa.
