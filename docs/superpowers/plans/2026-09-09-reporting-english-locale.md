...
The [exact-HEAD evidence record](repository_id=1212760346; pr_number=61; comment_id=5601896618)
...
`legacy-operator`, not public download URLs. The [exact-HEAD evidence record](repository_id=1212760346; pr_number=61; comment_id=5601896618)
...
[commit-specific DeepSource run](https://app.deepsource.com/gh/repository_id=1212760346; historical_repository_name=Codework/run/41339631-e574-4456-bee9-18d4da27b19d/python/).
